...
class CrmSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $leadStatuses = [LeadStatus::NEW, LeadStatus::QUALIFIED, LeadStatus::CONVERTED, LeadStatus::DISQUALIFIED];
        ...
        for ($i = 0; $i < count($companies); $i++) {
            ...
            $opportunity = Opportunity::create([
                'company_id' => $company->id,
                'lead_id' => $lead->id,
                'client_id' => $lead->status === LeadStatus::CONVERTED ? $company->client?->id : null,
                'assigned_to_id' => $assignedTo->id,
